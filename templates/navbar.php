...
<nav class="navbar navbar-expand-lg navbar-ocean sticky-top d-print-none">
...
<div class="mx-auto">
    <span class="fw-bold fs-4 text-secondary">
...
<ul class="navbar-nav mx-auto">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= BASEURL; ?>#tentang">Tentang</a>
    </li>

    <li class="nav-item">
        <a class="nav-link" href="<?= BASEURL; ?>#fasilitas">Fasilitas</a>
    </li>
    ...
    <ul class="navbar-nav align-items-center">
        ...
        <?php else : ?>
            ...
            <li class="nav-item">
                ...
                href="<?= BASEURL; ?>auth/login.php">
                    Masuk
                </a>
            </li>

            <li class="nav-item">
                <a class="btn btn-ocean rounded-pill px-4"
